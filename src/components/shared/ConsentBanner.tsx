  ...
  return (
    ...
    >
      ...
      <p style={{ margin: '9px 0 14px', fontSize: 14, lineHeight: 1.42 }}>
        Мы используем локальное хранилище, чтобы сохранять ваш прогресс и настройки — без него игра не сможет запоминать результаты.
        С вашего согласия подключим Яндекс Метрику, чтобы понять, какие уровни стоит улучшить. Играть можно и без аналитики.
      </p>
